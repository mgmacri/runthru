# Speedy Boy v3.0 — UX/UI Design Specification

**Product**: Speedy Boy v3.0 — Adaptive Reading with 3D Neumorphic Cube Viewport
**Spec Version**: 3.0.0
**Date**: 2026-04-01
**Supersedes**: `speedy_boy_design_spec_v2.md` v1.0.0
...
Shell surface tokens. Preset cards use `SpeedyBoyDecorations.raisedDecoration(SpeedyBoySurface.shell)`.
...
if (anchorContrastRatio < 4.5) {
  anchorShadow = Paint()
    ..color = SpeedyBoyTokens.stageText.withOpacity(0.3)
