...
- Rendering PDFs inline in the RunThru reading viewport — extracted text feeds into the existing RSVP word display.
...
```
Color Legend (use RunThruColors tokens):
...
## 10. Integration Points with RunThru v3

| RunThru Component | Integration |
|---|---|
